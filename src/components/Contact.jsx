...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "619ac402-8ad0-449e-94f7-d68a496d65d4");
  ...
  return (
    ...
    viewport={{once: true}}
    className='text-center p-6 py-20 lg:px-32 w-ful overflow-hidden' id='Contact'>
        ...
        <p className='text-center text-gray-500 max-w-80 mx-auto'>Ready to make a move? Let's Build Your Future together.</p>
        ...
        <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
            ...
            <button className='bg-pink-600 text-white py-2 px-12 mb-10 rounded'>{result ? result : "Send Message"}</button>
        </form>
    </motion.div>
  )
}
