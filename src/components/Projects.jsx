...
const Projects = () => {
  ...
  return (
    ...
    viewport={{once: true}}
    className='container mx-auto py-4 pt-20 md:px-20  lg:px-32 my-15 w-full overflow-hidden' id='Projects'>
        ...
        <div className='flex justify-end items-center mb-8'> 
            <button onClick={preProject} className='p-3 bg-gray-200 rounded mr-2' aria-label='Previous Project'>
                <img src={assets.left_arrow} alt="Previous" />
            </button>
            <button onClick={nextProject} className='p-3 bg-gray-200 rounded mr-2' aria-label='Next Project'>
                <img src={assets.right_arrow} alt="PreviNextous" />
            </button>
        </div>
        ...
        <div className='overflow-hidden'>
            ...
            >
                {projectsData.map((project,index)=>(
                    <div key={index} className='relative flex-shrink-0 w-full sm:w-1/4 shadow-md rounded-md overflow-hidden'>
                        {/* image */}
                        <img 
                            src={project.image}
                            alt={project.title} className='w-full h-auto mb-14'
                        />
